...
class Npm extends EventEmitter {
  ...
  get noColorChalk () {
    if (!this.#noColorChalk) {
      this.#noColorChalk = new this.#Chalk.Chalk({
        level: 0,
      })
    }
  ...
  get chalk () {
    if (!this.#chalk) {
      this.#chalk = new this.#Chalk.Chalk({
        level: this.color ? this.#Chalk.supportsColor.level : 0,
      })
    }
    return this.#chalk
  }
  ...
  get logChalk () {
    if (!this.#logChalk) {
      this.#logChalk = new this.#Chalk.Chalk({
        level: this.logColor ? this.#Chalk.supportsColorStderr.level : 0,
      })
    }
